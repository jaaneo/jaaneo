...
![IoT](https://img.icons8.com/external-flaticons-flat-flat-icons/32/000000/external-iot-internet-of-things-flaticons-flat-flat-icons.png)
...
## ![Skills](https://img.icons8.com/color/32/000000/brain.png) Habilidades y Competencias Técnicas

- ![Communication](https://img.icons8.com/color/32/000000/wifi.png) **Protocolos de Comunicación**:
  - Z-Wave, Zigbee, KNX.
- ![Integration](https://img.icons8.com/fluency/32/000000/device-manager.png) **Integración de Sistemas**:
  - Fibaro, Vimar, Home Assistant, HomeKit.
- ![Web Development](https://img.icons8.com/color/32/000000/source-code.png) **Desarrollo Web**:
  - HTML, CSS, JavaScript, Node.js, TypeScript, Astro, WordPress.
- ![CSS](https://img.icons8.com/color/32/000000/css-filetype.png) **Frameworks y Estilos**:
  - Tailwind CSS.
- ![Programming](https://img.icons8.com/color/32/000000/python--v1.png) **Lenguajes de Programación**:
  - Python, JavaScript (Node.js), TypeScript.
- ![Terminal](https://img.icons8.com/fluency/32/000000/console.png) **Herramientas de Desarrollo**:
  - Bash, terminal, Linux.
- ![Automation](https://img.icons8.com/color/32/000000/automation.png) **Automatización y Control**:
...
## ![Experience](https://img.icons8.com/color/32/000000/work.png) Experiencia Destacada
...
## ![Contact](https://img.icons8.com/color/32/000000/communication.png) Contacto
